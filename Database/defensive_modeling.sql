...
--
-- Host: localhost
-- Generation Time: Mar 05, 2021 at 12:25 AM
...
--
-- Database: `defensive_modeling`
--
CREATE DATABASE IF NOT EXISTS `defensive_modeling` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `defensive_modeling`;
...
(9, 'Gopinath', 'Gopinath123@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_defensive_modeling_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_defensive_modeling_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
  `uname` varchar(300) NOT NULL,
  `gender` varchar(300) NOT NULL,
  `address` varchar(300) NOT NULL,
  `news_subject` varchar(300) NOT NULL,
  `news_desc` varchar(30000) NOT NULL,
  `news_date` varchar(300) NOT NULL,
  `posted_country` varchar(300) NOT NULL,
  `posted_media` varchar(300) NOT NULL,
  `news_Score` int(30) NOT NULL,
  `news_group` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `remote_user_news_accuracy_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_news_accuracy_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
